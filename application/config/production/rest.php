...
|
*/
$config['auth_library_class'] = 'smartc_auth';
$config['auth_library_function'] = 'api_login';
...
|
*/
//$config['auth_override_class_method']['v1']['*'] = 'none';
...
// ---Uncomment list line for the wildard unit test
//$config['auth_override_class_method_http']['v1']['template']['get'] = 'none';
...
|
*/
$config['rest_handle_exceptions'] = FALSE;
